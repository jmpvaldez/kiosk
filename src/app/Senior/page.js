      ...
      <div className="w-full mt-24" id="accordion-open" data-accordion="open">
        ...
        <div id="accordion-open-body-1" className="hidden" aria-labelledby="accordion-open-heading-1">
          <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
            <p className="mb-2 text-gray-500 dark:text-gray-400">The Social Pension for Indigent Senior Citizens (SPISC) is in compliance with the Republic Act No. 9994 or the “Expanded Senior Citizens Act of 2010” which institutionalizes social protection to senior citizens by providing additional government assistance to indigent senior citizens which aims to augment the daily subsistence and 217 other medical needs of the eligible beneficiaries based on the eligibility criteria as mentioned below.</p>
        ...
        */}   </div>
        ...
        <div id="accordion-open-body-2" className="hidden" aria-labelledby="accordion-open-heading-2">
          <div className="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
            <p className="mb-2 text-gray-500 dark:text-gray-400">OSCA ID or any Valid ID
Social Pension Application Form</p>
        ...
        <div id="accordion-open-body-3" className="hidden" aria-labelledby="accordion-open-heading-3">
          <div className="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
            <p className="mb-2 text-gray-500 dark:text-gray-400">Indigent senior citizens who are:</p>
