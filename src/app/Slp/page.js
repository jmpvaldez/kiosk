  ...
  const contentData = [
    {
      ...
      title:
        "School ID",
      content: `
      The process of issuing Certificate of Accreditation to Civil Society Organizations (CSOs) Beneficiaries of DSWD Projects and/or Program Organized by the Sustainable Livelihood Program (SLP). 
      `,
    },
    {
      id: 2,
      title:
        "School ID",
      content: `
      1. Certified true copy of the Certificate of Eligibility (CoE) *The issuance of COE is subject to compliance on SLP existing guidelines<br>
2. Endorsement of SLPAs with CoE signed by the Regional Program Coordinator (to include the project/s approved, address of the SLPA, and the budget approved for the project)<br>
      `,
    },
    {
      id: 3,
      title:
        "School ID",
      content: `
      All eligible beneficiary CSOs organized by the Department through SLP
    ...
    <main className="h-screen flex flex-col items-start justify-start p-12 md:py-14  lg:px-36 ">
      ...
      <div className="flex mt-6 items-start  md:items-center flex-col md:flex-row justify-between w-full mb-4">
        <div className=" text-gray-500 font-bold items-center gap-6 p-3  md:text-5xl flex flex-row">
          ...
          />
          <p>Sustainable Livelihood Program (SLP)</p>
        </div>
